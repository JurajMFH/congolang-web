...
**"We build together."** Inspired by the core values of the Masakhane community, CongoLang is a grassroots, participatory Natural Language Processing (NLP) project dedicated to building open, high-quality, and human-validated datasets for under-resourced Central African languages (starting with Standard and Urban Lingala).
